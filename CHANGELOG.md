...
## [1.33.0](https://github.com/rodineyw/career-ops/compare/career-ops-v1.32.0...career-ops-v1.33.0) (2026-09-15)
...
* **batch:** add --cli flag for multi-CLI batch evaluation ([244d193](https://github.com/rodineyw/career-ops/commit/244d1933d5ee1ebd4999a7b796654043a477f2af)), closes [#737](https://github.com/rodineyw/career-ops/issues/737)
* **batch:** add --cli flag for multi-CLI batch evaluation (opencode, gemini, qwen) ([6255cc2](https://github.com/rodineyw/career-ops/commit/6255cc200be7aabe45bf1d5c2ec2e6f52337fd7f))
...
* **garena:** route id encoding through _safe-url so one bad posting drops, not the page ([7bee848](https://github.com/rodineyw/career-ops/commit/7bee8480f4a3571d47fd9b2ba888122a21e52c0c))
...
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([cfc6b01](https://github.com/rodineyw/career-ops/commit/cfc6b0190eac5a1c919aefeb28a008a97b4d8864))
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([5c65257](https://github.com/rodineyw/career-ops/commit/5c652575fd43e818ee0f1be7dc0aff646a3e773e))
...
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([7cdd684](https://github.com/rodineyw/career-ops/commit/7cdd6845278948b4d8379fb2fcebf39304e54994))
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([d76bea0](https://github.com/rodineyw/career-ops/commit/d76bea0e1c3f9a8f3aab20ce583812774ceda23c))
...
* **providers:** coerce before the try; drop tkms encode of the config locale ([94eebce](https://github.com/rodineyw/career-ops/commit/94eebced04e524572e201ee65df275a60f370771))
...
* **providers:** route feishu-jobs and mokahr id encoding through _safe-url ([fd3966a](https://github.com/rodineyw/career-ops/commit/fd3966aa50fbe8e2b603cf6a226c8b8ae777f3e1))
...
* **rheinmetall:** guard the slug-fallback decode against a malformed percent-escape ([6efda1c](https://github.com/rodineyw/career-ops/commit/6efda1c1003188d70a1323685d44fd3882e6c3ed))
...
* **tkms:** re-encode the config locale, hoisted out of the row loop to fail loud ([5b8f1f0](https://github.com/rodineyw/career-ops/commit/5b8f1f0d6cf5900c1cc557bd9c391239801fe4ff))
